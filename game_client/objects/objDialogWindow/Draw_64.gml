...
if question {
	...
	var textbox_y = y+sprite_height-128;
	var textbox_h = 32;
	...
	draw_gui_border(x+16,textbox_y,x+sprite_width-16,textbox_y+textbox_h,c_ltgray,false)
	var textX = x+16+4;
	...
	if hover {
		draw_gui_border(buttonX,buttonY,buttonX+128,buttonY+32,global.colors.dark_blue_25,false)	
	}
	draw_gui_border(buttonX,buttonY,buttonX+128,buttonY+32,global.colors.dark_blue_50,true)
	draw_set_halign(fa_center)
	...
	for(var i=0; i<array_length(options); i++) {
		...
		if hover {
			draw_gui_border(drawX,drawY,drawX+button_width,drawY+48,global.colors.dark_blue_25,false)	
		}
		draw_gui_border(drawX,drawY,drawX+button_width,drawY+48,global.colors.dark_blue_50,true)
		draw_set_halign(fa_center)
		draw_set_valign(fa_middle)
