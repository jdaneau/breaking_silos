...
up = place_meeting(x,y-1,objMapTile) || place_meeting(x,y-1,objForeignTile)
left = place_meeting(x-1,y,objMapTile) || place_meeting(x-1,y,objForeignTile)
right = place_meeting(x+1,y,objMapTile) || place_meeting(x+1,y,objForeignTile)
down = place_meeting(x,y+1,objMapTile) || place_meeting(x,y+1,objForeignTile)
