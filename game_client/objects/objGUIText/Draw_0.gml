...
if fill {
	...
	draw_rectangle(x,y,x+sprite_width,y+sprite_height,outline)
...
if outline {
	...
	draw_text_ext_transformed(_x-1,_y,text,sep*scale,sprite_width,scale,scale,image_angle)
	draw_text_ext_transformed(_x+1,_y,text,sep*scale,sprite_width,scale,scale,image_angle)
	draw_text_ext_transformed(_x,_y-1,text,sep*scale,sprite_width,scale,scale,image_angle)
	draw_text_ext_transformed(_x,_y+1,text,sep*scale,sprite_width,scale,scale,image_angle)
}
