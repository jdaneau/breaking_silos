...
var struct = {
	...
	starting_flood_risk : 0,
	starting_drought_risk : 0,
...
for (n=0; n<instance_number(objMapTile); ++n;) {
	...
	struct.starting_drought_risk += _tile.metrics.drought_risk
	struct.starting_flood_risk += _tile.metrics.flood_risk
}
