...
draw_text(calc_width/2 + 16, end_y+(row_height/2),            "National Budget: "+string(budget))
draw_text(calc_width/2 + 16, end_y+row_height+(row_height/2), "Money Left:      "+string(budget-total))
